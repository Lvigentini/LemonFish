...
class OntologyGenerator:
    """
    本体生成器
    analyzetextcontent, generateentityandrelationship typesdefinition
    """
    ...
    def __init__(self, llm_client: Optional[LLMClient] = None):
        ...
        if Config.LLM_ONTOLOGY_MAX_TEXT_LENGTH:
            self.MAX_TEXT_LENGTH_FOR_LLM = Config.LLM_ONTOLOGY_MAX_TEXT_LENGTH
...
"""
    ...
    def generate_python_code(self, ontology: Dict[str, Any]) -> str:
        ...
        code_lines.append('# ============== relationship typesdefinition ==============')
        code_lines.append('')
        
        # generaterelationship types
