...
const goToNextStep = () => {
  // TODO: proceed to environment setupstep
  alert('环境搭建功能开发中...')
}
...
// initialise — handle new project or load existing
...
const renderGraph = () => {
  ...
  // createnodemappingused forlookupname
  const nodeMap = {}
  nodesData.forEach(n => {
    nodeMap[n.uuid] = n
  })
  ...
  // createnodeIDsetused forfiltervalidedge
...
/* edge detailsrelationship display */
.edge-relation {
  display: flex;
  align-items: center;
  flex-wrap: wrap;
